        ...
        return (
            <div className="col-10 m-auto pt-2">
                <form className="form-edit p-4 mb-3 bg-body rounded-c shadow" id="formUserSettings" onSubmit={this.handleSubmit} >
                    <h1 className="h3 mb-3 fw-normal text-center fw-bold">{t('Settings')}</h1>
                    ...
                    <div className="form-floating mb-2">
                        <input defaultValue={link} type="url" className="form-control" name="Link" id="siteInput" placeholder="Site" data-tempmail="0" />
                        <label htmlFor="siteInput">Site</label>
                    </div>

                    <div className="form-floating mb-2">
                        <select value={location} className="form-select" name="Location" id="locationInput" aria-label="Default select example">
                            <option defaultValue="">Open this select menu</option>
                        ...
                        <label htmlFor="locationInput">Country</label>
                    </div>
